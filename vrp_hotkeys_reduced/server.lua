...
function vRPhk.docsOnline()
  local docs = vRP.getUsersByPermission({"emergency.doc"})
  return #docs
end
...
function vRPhk.helpComa(x,y,z)
  vRP.sendServiceAlert({source,"emergency",x,y,z,"Lifeinvater emergency call incoming."}) -- people will change this message anyway haha
end
